...
$statement = $pdo->prepare("SELECT * FROM tbl_users where daxoa=0 and (id_user  regexp '$search'  or ten_user regexp '$search') and  trangthai regexp '$trangthaihd' and id_loaitk regexp '$loaitk'");
$statement->execute();
...
$search = $_GET['search'];
$statement = $pdo->prepare("SELECT * FROM tbl_users where daxoa = 0 and (id_user  regexp '$search'  or  ten_user regexp '$search') and trangthai regexp '$trangthaihd'  and id_loaitk regexp '$loaitk' limit $sodong offset $min");
$statement->execute();
