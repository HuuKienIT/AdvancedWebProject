...
if (isset($_POST['thanhtoan'])) {
    ...
    foreach ($_SESSION['cart'] as $spnh) {
        ...
        if($spnh['soluong']>$soluongtemp){
            echo "<script type='text/javascript'>alert('Có sản phẩm đã vượt quá số lượng trong kho');</script>";
            $valid=0;
        }  
    }
    if ($valid == 1) {
                        ...
                        <div class="cart-body row mt-2 border shadow text-center d-flex align-items-center py-2">
                            ...
                            <div class="col-md-3 mx-auto">
                                <div class="row d-flex justify-content-center">
                                    <span class="quantity-btn minus" onclick="TangGiamSL(<?php echo $row['id_pro'] + $row['size'] ?>,-1),show(<?php echo $row['id_pro'] ?>, <?php echo $row['size'] ?>,-1)"><img src="../uploads/minus.jpg" style="width:70%;"></span>
                                    ...
                                    <span class="quantity-btn plus" onclick="TangGiamSL(<?php echo $row['id_pro'] + $row['size'] ?>,1),show(<?php echo $row['id_pro'] ?>, <?php echo $row['size'] ?>,1)"><img src="../uploads/add.jpg" style="width: 70% ;"></span>
                                </div>
                            </div>
                            <form method="POST">
